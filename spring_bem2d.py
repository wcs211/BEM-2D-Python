...
for i in xrange(START_COUNTER, COUNTER):
    if i == 0:
        ...
        while True:
            ...
            FSIL[0].setSpringForce(Swimmers[0].Body, SolidL[0], PyFEAL[0], P, outerCorr, 0., i)            
            PyFEAL[0].spring_solve()
            FSIL[0].getRotation(SolidL[0], Swimmers[0].Body, PyFEAL[0], SW_INTERP_MTD)
